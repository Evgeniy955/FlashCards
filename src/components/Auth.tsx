...
// FIX: Switched to named imports for Firebase auth functions and types to resolve "no exported member" and "property does not exist" errors, aligning with the Firebase v9+ modular SDK.
