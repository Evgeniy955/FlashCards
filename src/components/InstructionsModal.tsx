...
|    собака   |   |     dog      |`}
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li><strong>Practice Again:</strong> После завершения сессии вы можете пройти весь набор заново в режиме практики. Этот режим не влияет на ваш основной прогресс и отлично подходит для быстрого повторения.</li>
        </ul>
      </section>
...
|    собака   |   |     dog      |`}
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-2">
          ...
          <li><strong>Practice Again:</strong> Після завершення сесії ви можете пройти весь набір заново в режимі практики. Цей режим не впливає на ваш основний прогрес і чудово підходить для швидкого повторення.</li>
        </ul>
      </section>
