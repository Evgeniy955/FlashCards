...
const RussianContent: React.FC = () => (
    <>
      <section>
        ...
        <p>
          На главном экране нажмите кнопку <strong>"Get Started"</strong>. Откроется окно, где вы можете выбрать источник слов:
        </p>
        <ul className="list-disc list-inside space-y-2 mt-3">
          <li><strong>Built-in:</strong> Выбрать один из готовых, встроенных словарей.</li>
          <li><strong>My Dictionaries:</strong> Выбрать из словарей, которые вы ранее загрузили с компьютера.</li>
    ...
    <>
      <section>
        ...
        <ul className="list-disc list-inside space-y-2 mt-3">
          ...
          <li><strong>My Dictionaries:</strong> Вибрати зі словників, які ви раніше завантажили з комп'ютера.</li>
